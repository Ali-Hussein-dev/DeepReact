    ...
    return (
      ...
      >
        ...
        <div className="relative">
          {open && (
            <CommandList
              className="absolute top-1 z-10 max-h-[200px] w-full overflow-auto border border-border bg-popover text-popover-foreground shadow-md outline-none animate-in"
              onMouseLeave={() => {
