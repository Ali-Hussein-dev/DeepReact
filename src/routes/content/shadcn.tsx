...
import { shadcnTags } from "@/constants/filter-tags";
...
export const Route = createFileRoute("/content/shadcn")({
...
function FilterSidebar() {
	const search = useSearch({ from: "/content/shadcn" });
	const activeTags =
...
function RouteComponent() {
	...
	const searchParam = useSearch({ from: "/content/shadcn" });
